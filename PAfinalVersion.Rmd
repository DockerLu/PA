...
```{r}
library(openxlsx)
#dat = read.xlsx("/Users/luxiong/Dropbox/Actuarial research seminar/Humana case competition/Team folder/Tingting Sun/PA/dat2.xlsx")
vars <- colnames(dat)[6:length(dat)-1]
