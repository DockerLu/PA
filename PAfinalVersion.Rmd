...
dat <- read.xlsx("/Users/luxiong/Dropbox/Actuarial research seminar/Humana case competition/Team folder/Tingting Sun/PA/dat_afterPCA.xlsx")
...
```{r}
GLMgammaR <- glm(gapdays+1 ~ ICD9_DIAGNOST_CODE + DOCTOR.NUMBER + Age + PATIENT.MARITAL.STATUS + 
    Surgeon + DISCHARGE.STATUS + income_level + Patient.Days, family = Gamma(link = "log"), data = train)
summary(GLMgammaR)
print("AIC")
AIC(GLMgammaR)
